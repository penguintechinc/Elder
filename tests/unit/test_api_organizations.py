...
class TestOrganizationAPI:
    ...
    def test_update_organization(self, mock_jwt, client, app):
        ...
        with app.app_context():
            ...
            response = client.patch(f'/api/v1/organizations/{org_id}',
                                  data=json.dumps(payload),
                                  content_type='application/json',
                                  headers={'Authorization': 'Bearer fake-token'})
    ...
    def test_get_organization_children(self, mock_jwt, client, app):
        ...
        with app.app_context():
            ...
            response = client.get(f'/api/v1/organizations/{parent.id}/children',
                                headers={'Authorization': 'Bearer fake-token'})
    ...
    def test_organization_pagination(self, mock_jwt, client, app):
        ...
        with app.app_context():
            ...
            response = client.get('/api/v1/organizations?page=1&per_page=10',
                                headers={'Authorization': 'Bearer fake-token'})
